                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" name="cnpj" id="cnpj" placeholder="CNPJ" required value="{{ $client->cnpj }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" name="cep" id="cep" placeholder="CEP" value="{{ $client->cep }}">
